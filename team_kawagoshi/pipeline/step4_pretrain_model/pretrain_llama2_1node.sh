...
output_model_dir="/storage2/output/1node" #"${output_model_dir%/}"  # Removes a trailing slash "/" if it exists.

DATASET_1="/storage2/datasets/test_ja_input/ja_wiki_text_text_document"
#"/storage2/datasets/en_input/slimpajama_github_final_text_document"
DATASET="1 ${DATASET_1}"
TOKENIZER_PATH="/storage2/llm-jp-tokenizer/models/ver2.2/code20K_en40K_ja60K.ver2.2.model"
#"/storage2/ja60K_en40K_code20K.model"
