...
def merge_tp_slices(ds_checkpoint, dir, slice_dir, tp_degree, name_and_shape):
    ...
    #print(f"universal_checkpoint_info {universal_checkpoint_info}")
    def get_matched_pattern(patterns_, name_):
        ...
        if matched_:
            ...
            #print(f'matched patterns_: {patterns_}, name_: {name_}')
            return pattern_
        #print(f'patterns_: {patterns_}, name_: {name_}')
        return None
    ...
    def get_matched_sub_params_pattern(name_):
        ...
        return None
    #if name == "language_model.output_layer.weight":
    #    name = "language_model.output_layer.lm_head.weight"
    #print(f"name {name}")
...
def _extract_zero_shard_files(args, ds_checkpoint, temp_dir):
    ...
    #print(f'work_chunks {work_chunks}')
