...
python  ${llm_jp_tokeninzer_dir}/hf/convert_llmjp_unigram_spm_to_hf_fast.py \
...
python ${megatron_deepspeed_dir}/tools/convert_checkpoint/deepspeed_to_megatron_v3.py \
    --input_folder ${input_model_dir} \
    --output_folder ${temp_model_dir} \
    --target_pp ${target_pp} \
    --target_tp ${target_tp}

python ${ucllm_nedo_dev_train_dir}/pipeline/step5_upload_pretrained_model/llama_checkpoint_conversion_v3.py \
