...
dataset_path="team-hatakeyama-phase2/synth-magpie-jp-coding-nemotron-4"
dataset_lang="default"
dataset_split="train"
dataset_fields="messages"
...
wandb_name="synth-magpie-jp-coding-nemotron-4"
...
# for train split
# time split -l 250000 -d -a 5 --additional-suffix=-of-00002.jsonl output_train.jsonl train-
