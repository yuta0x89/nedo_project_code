...
#SBATCH --mem=1600GB
#SBATCH --job-name=judge_math_q_a_a
...
input_jsonl="data/basic-math-sftbest-1.20240810.tanuki_q_a_a.jsonl"
output_jsonl="data/basic-math-sftbest-1.20240810.tanuki_q_a_a.nemotron_judge.jsonl"
skip_jsonl="data/basic-math-sftbest-1.20240810.tanuki_q_a_a.nemotron_judge_skip.jsonl"
dataset_path=""
