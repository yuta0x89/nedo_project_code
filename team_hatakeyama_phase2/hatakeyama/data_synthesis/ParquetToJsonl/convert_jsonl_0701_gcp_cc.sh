...
# cc from hf cleaned
python parquet_to_jsonl.py --input_path /storage5/shared/corpus/synthetic/SyntheticTexts/0617out_data_cleaned --out_dir ../../2nd_tonyu/hf_synth/SyntheticTextCC_0701gcp --column_name ja --do_clean false