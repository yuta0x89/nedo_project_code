...
# cc from hf cleaned
python parquet_to_jsonl_ca.py --input_path /storage5/shared/corpus/synthetic/SyntheticTexts/0712out_data_ca --out_dir ../../2nd_tonyu/hf_synth/synth_text_gcp_ca0716 --column_name ja --do_clean false