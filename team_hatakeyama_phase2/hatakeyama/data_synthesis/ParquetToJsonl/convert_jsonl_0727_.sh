...
# cc from hf cleaned
python parquet_to_jsonl_ca.py --input_path /storage5/shared/corpus/synthetic/SyntheticTexts/0723multiturn_cl \
--out_dir /storage5/shared/p2_corpus/temporary_data/0723out_multiturn_cl_gcp --column_name text --do_clean false