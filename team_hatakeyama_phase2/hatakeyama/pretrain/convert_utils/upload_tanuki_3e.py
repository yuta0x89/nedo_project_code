...
def main() -> None:
    ...
    local_tokenizer.push_to_hub("team-hatakeyama-phase2/8b-3e-4-iter-"+args.huggingface_name)
    local_model.push_to_hub("team-hatakeyama-phase2/8b-3e-4-iter-"+args.huggingface_name)
