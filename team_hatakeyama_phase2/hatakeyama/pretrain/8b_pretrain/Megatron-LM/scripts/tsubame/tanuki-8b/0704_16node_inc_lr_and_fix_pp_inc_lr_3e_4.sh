...
CHECKPOINT_ARGS="--load /storage5/shared/Llama-3-8/tp1-pp4-ct1-LR1.5E-4-MINLR1.5E-5-WD0.1-WARMUP1000-nnodes16 --no-load-optim"

JOB_NAME="Llama-3-8b-0704_hatakeyama_16nodes_inc_lr_3e_4"
