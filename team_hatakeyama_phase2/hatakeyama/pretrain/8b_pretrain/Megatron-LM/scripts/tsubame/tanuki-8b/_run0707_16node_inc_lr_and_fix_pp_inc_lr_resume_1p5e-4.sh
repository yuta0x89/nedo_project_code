...
MASTER_PORT=6004
chmod +x 0707_16node_inc_lr_and_fix_pp_inc_lr_resume_1p5e-4.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        cd $SCRIPT_ROOT && \
        bash /storage5/shared/hatakeyama/0611te/Megatron-LM/scripts/tsubame/tanuki-8b/0707_16node_inc_lr_and_fix_pp_inc_lr_resume_1p5e-4.sh $NODE_RANK
