...
MASTER_PORT=6004
chmod +x 0628_16node_restart_from_0628.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        cd $SCRIPT_ROOT && \
        bash /storage5/shared/hatakeyama/0611te/Megatron-LM/scripts/tsubame/tanuki-8b/0628_16node_restart_from_0628.sh $NODE_RANK
