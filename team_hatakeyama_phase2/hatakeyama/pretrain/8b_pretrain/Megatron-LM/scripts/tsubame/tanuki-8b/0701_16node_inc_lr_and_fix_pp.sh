...
CHECKPOINT_ARGS="--load /storage5/shared/Llama-3-8/tp1-pp2-ct1-LR4E-5-MINLR1.0E-6-WD0.1-WARMUP1000-nnodes16 --no-load-optim"

JOB_NAME="Llama-3-8b-0701_hatakeyama_16nodes_inc_lr"
