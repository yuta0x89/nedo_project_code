...
#MASTER_PORT=6004
NNODES=16
chmod +x llama-3-35b_16_tp_4_pp_4_shared_env_suppress_spike_2nd_dataset_restart_low_lr_0623_2.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        ...
        cd $SCRIPT_ROOT && \
        bash $SCRIPT_ROOT/scripts/tsubame/Llama-3-35b/llama-3-35b_16_tp_4_pp_4_shared_env_suppress_spike_2nd_dataset_restart_low_lr_0623_2.sh $NODE_RANK
