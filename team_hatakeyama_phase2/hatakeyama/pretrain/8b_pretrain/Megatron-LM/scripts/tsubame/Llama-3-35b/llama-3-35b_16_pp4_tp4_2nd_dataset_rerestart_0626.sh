...
#ck_restart_dir="/storage5/shared/Llama-3-35/Llama-3-35b-16nodes_2nd_tonyu-tp4-pp4-ct1-LR5E-6-MINLR4.9E-6-WD0.1-WARMUP8000"
#CHECKPOINT_ARGS="--load ${ck_restart_dir} --no-load-optim"

#特定のcheckpointからの再開 (loader も初期化)
ck_restart_dir="/storage5/shared/Llama-3-35/Llama-3-35b-16nodes_2nd_tonyu-tp4-pp4-ct1-LR2E-6-MINLR1.99E-6-WD0.1-WARMUP2000"
