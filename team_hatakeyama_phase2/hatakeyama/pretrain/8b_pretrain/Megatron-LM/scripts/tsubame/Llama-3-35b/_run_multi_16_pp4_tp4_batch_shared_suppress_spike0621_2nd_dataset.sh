...
#MASTER_PORT=6004
NNODES=16
chmod +x llama-3-35b_16_tp_4_pp_4_shared_env_suppress_spike0621_2nd_dataset.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        ...
        cd $SCRIPT_ROOT && \
        bash $SCRIPT_ROOT/scripts/tsubame/Llama-3-35b/llama-3-35b_16_tp_4_pp_4_shared_env_suppress_spike0621_2nd_dataset.sh $NODE_RANK
