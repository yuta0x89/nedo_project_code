...
SCRIPT_ROOT=$HOME/Megatron-LM
WANDB_RUN_NAME=llama3
#MASTER_ADDR=hostname
MASTER_PORT=6003
#MASTER_PORT=6004
NNODES=16
chmod +x llama-3-35b_16_tp_4_pp_4_kato_env_0618.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        conda activate jk_py310_tsubame_conda-mpi_TEv1.7_FAv2.5.7 && \
        cd $SCRIPT_ROOT && \
        bash $SCRIPT_ROOT/scripts/tsubame/Llama-3-35b/llama-3-35b_16_tp_4_pp_4_kato_env_0618.sh $NODE_RANK
