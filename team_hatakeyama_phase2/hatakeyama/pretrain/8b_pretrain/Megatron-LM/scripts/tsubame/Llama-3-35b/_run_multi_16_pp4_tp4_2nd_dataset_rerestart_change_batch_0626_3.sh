...
#MASTER_PORT=6004
NNODES=16
chmod +x llama-3-35b_16_pp4_tp4_2nd_dataset_rerestart_change_batch_0626_3.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        ...
        cd $SCRIPT_ROOT && \
        bash $SCRIPT_ROOT/scripts/tsubame/Llama-3-35b/llama-3-35b_16_pp4_tp4_2nd_dataset_rerestart_change_batch_0626_3.sh $NODE_RANK
