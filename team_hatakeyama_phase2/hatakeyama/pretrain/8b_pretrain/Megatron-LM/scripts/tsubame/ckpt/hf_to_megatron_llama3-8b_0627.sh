...
# model config
HF_CHECKPOINT_DIR=/storage5/llm/models/hf/step62160_fin
MEGATRON_CHECKPOINT_DIR=/storage5/shared/checkpoints/llama8b_step62160_tp${TENSOR_PARALLEL_SIZE}_pp${PIPELINE_PARALLEL_SIZE}
