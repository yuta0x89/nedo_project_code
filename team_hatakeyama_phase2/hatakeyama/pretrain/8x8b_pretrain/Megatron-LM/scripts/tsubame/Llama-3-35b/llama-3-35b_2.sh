...
CHECKPOINT_DIR="/storage5/shared/Nishijima/test"
CHECKPOINT_SAVE_DIR="/storage5/shared/Nishijima/test2"
...
#     2>&1 | tee ${log_file}"
#else
run_cmd="torchrun $DISTRIBUTED_ARGS /storage5/shared/hatakeyama/0611te/Megatron-LM/pretrain_gpt.py
  ${megatron_options}"
#fi
