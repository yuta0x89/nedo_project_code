...
CHECKPOINT_DIR=None #"/storage5/shared/Nishijima/mergekit/megatron_model/iter0028000"
...
TRAIN_DATA_PATH="/storage5/shared/corpus/phase1_tokenizer_data/tokenized/synth/openmath_text_document"
...
#  ${megatron_options}"
run_cmd="torchrun $DISTRIBUTED_ARGS /home/ext_yokobase_gmail_com/ABEJA/Megatron-LM/forward_test_gpt.py
  ${megatron_options}"
