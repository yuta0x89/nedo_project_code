...
CHECKPOINT_DIR="/storage5/shared/Nishijima/mergekit/megatron_model/iter0029000"
...
#  ${megatron_options}"
run_cmd="torchrun $DISTRIBUTED_ARGS /home/ext_yokobase_gmail_com/ABEJA/Megatron-LM/generate_gpt.py
  ${megatron_options}"
