...
CHECKPOINT_DIR="/storage5/shared/Nishijima/mergekit/megatron_model/iter_0049500_v4_"
...
#  ${megatron_options}"
run_cmd="torchrun $DISTRIBUTED_ARGS /home/ABEJA/Megatron-LM/pretrain_gpt.py
  ${megatron_options}"
