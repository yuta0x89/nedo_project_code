...
CHECKPOINT_DIR="/storage5/shared/Nishijima/mergekit/model_core/0111000_uniform__"
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8-8MoE_/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"
