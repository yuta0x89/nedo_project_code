...
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8b-MoE/4x8_wo_zloss_tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"

DATA_PATH_LIST=(
"/storage5/shared/corpus/moe_test/normal_bin/0_text_sentence"
"/storage5/shared/corpus/moe_test/normal_bin/1_text_sentence"
"/storage5/shared/corpus/moe_test/normal_bin/2_text_sentence"
"/storage5/shared/corpus/moe_test/normal_bin/3_text_sentence"
"/storage5/shared/corpus/moe_test/normal_bin/4_text_sentence"
"/storage5/shared/corpus/moe_test/normal_bin/5_text_sentence"
)
...
CHECKPOINT_DIR="/storage5/shared/Llama-3-8-8MoE/hatakeyama_test/0708model_four_pp2_tp4"
#finetune
# checkpoint load
if [[ -f "${CHECKPOINT_SAVE_DIR}/latest_checkpointed_iteration.txt" ]]; then
  # resume training

  #データローダーなどは初期化する for best fit packの検証
...
JOB_NAME="Llama-3-8b-MoE_hatakeyama_best_fit_test"
