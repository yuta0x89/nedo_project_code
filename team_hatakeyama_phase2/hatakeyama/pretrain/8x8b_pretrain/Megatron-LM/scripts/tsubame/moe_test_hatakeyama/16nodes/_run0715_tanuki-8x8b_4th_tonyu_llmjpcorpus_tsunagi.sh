...
NNODES=16
chmod +x /storage5/Megatron-LM/scripts/tsubame/moe_test_hatakeyama/16nodes/0715_tanuki-8x8b_4th_tonyu_llmjpcorpus_tsunagi.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "cd $SCRIPT_ROOT && \
        bash /storage5/Megatron-LM/scripts/tsubame/moe_test_hatakeyama/16nodes/0715_tanuki-8x8b_4th_tonyu_llmjpcorpus_tsunagi.sh $NODE_RANK
