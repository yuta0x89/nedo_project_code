...
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_ck0126000_std0001_tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"
...
JOB_NAME="Llama-3-8x8b-MoE_ck0126000_std0001"
