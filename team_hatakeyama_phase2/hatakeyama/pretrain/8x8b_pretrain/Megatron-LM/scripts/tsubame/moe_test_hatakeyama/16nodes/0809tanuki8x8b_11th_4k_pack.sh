...
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_0809_11th_tonyu_tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"
#数学系
DATA_PATH_LIST=(
"/storage5/shared/p2_corpus/4096_packed_data/4096_tokenized_data/20240809_b/4096_packed_data_20270809_bacth/4096_packed_data_20270809_bacth_b3g1_text_sentence"
"/storage5/shared/p2_corpus/4096_packed_data/4096_tokenized_data/20240809_b/4096_packed_data_20270809_bacth/4096_packed_data_20270809_bacth_b3g2_text_sentence"
"/storage5/shared/p2_corpus/4096_packed_data/4096_tokenized_data/20240809_b/4096_packed_data_20270809_bacth/4096_packed_data_20270809_bacth_b3g3_text_sentence"
"/storage5/shared/p2_corpus/4096_packed_data/4096_tokenized_data/20240809_b/4096_packed_data_20270809_bacth/4096_packed_data_20270809_bacth_b3g4_text_sentence"
)
...
CHECKPOINT_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_0809_11th_tonyu_tp1-pp16-ct1-LR5.0E-5-MINLR5.0E-6-WD0.1-WARMUP500"
...
ck_restart_dir="/storage5/shared/Llama-3-8b-MoE/8x8_0806_10th_tonyu_tp1-pp16-ct1-LR1.0E-5-MINLR1.0E-7-WD0.1-WARMUP50"
CHECKPOINT_ARGS="--load ${ck_restart_dir} --finetune"


JOB_NAME="Llama-3-8x8b-MoE_0809_11th_tonyu"
