...
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_0712_2nd_tonyu_tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"

DATA_PATH_LIST=(
"/storage5/split/split/split/tokenized_text_document"
...
CHECKPOINT_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_ck0126000_std0001_tp1-pp16-ct1-LR5.0E-5-MINLR5.0E-6-WD0.1-WARMUP1000"
...
JOB_NAME="Llama-3-8x8b-MoE_0712_2nd_tonyu"
