...
CHECKPOINT_SAVE_DIR="/storage5/shared/Llama-3-8b-MoE/8x8_tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}-LR${LR}-MINLR${MIN_LR}-WD${WEIGHT_DECAY}-WARMUP${LR_WARMUP_STEPS}"
...
CHECKPOINT_DIR="/storage5/shared/Llama-3-8-8MoE/hatakeyama_test/0708eight"
#finetune
# checkpoint load
