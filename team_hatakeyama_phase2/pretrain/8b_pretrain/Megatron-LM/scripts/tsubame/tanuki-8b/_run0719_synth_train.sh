...
MASTER_PORT=6004
chmod +x /storage5/shared/hatakeyama/0611te/Megatron-LM/scripts/tsubame/tanuki-8b/0719_synth_train.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        cd $SCRIPT_ROOT && \
        bash /storage5/shared/hatakeyama/0611te/Megatron-LM/scripts/tsubame/tanuki-8b/0719_synth_train.sh $NODE_RANK
