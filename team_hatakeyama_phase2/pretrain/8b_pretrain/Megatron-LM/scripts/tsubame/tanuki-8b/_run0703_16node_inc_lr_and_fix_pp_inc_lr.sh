...
MASTER_PORT=6004
chmod +x 0703_16node_inc_lr_and_fix_pp_inc_lr.sh
...
for node in "${NODES[@]}"; do
    ...
    ssh -q $node "
        cd $SCRIPT_ROOT && \
        bash /storage5/shared/hatakeyama/0611te/Megatron-LM/scripts/tsubame/tanuki-8b/0703_16node_inc_lr_and_fix_pp_inc_lr.sh $NODE_RANK
