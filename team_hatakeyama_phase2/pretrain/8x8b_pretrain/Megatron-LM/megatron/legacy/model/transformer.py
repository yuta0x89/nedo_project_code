...
class SwitchMLP(MegatronModule):
    ...
    def __init__(self, config):
        ...
        args = get_args()
        print(f"mpu.get_expert_model_parallel_world_size() : {mpu.get_expert_model_parallel_world_size()}")
        ...
        self.add_bias = config.add_bias_linear
        print(f"args.num_experts :{args.num_experts % self.expert_parallel_size}")
