...
if __name__ == "__main__":
    ...
    dataset = load_dataset(
        "alfredplpl/commoncatalog-cc-by-ext", cache_dir="./cache"
    )
    ...
    for key in INSTRUCTIONS.keys():
        ...
        caption_path = Path(
            "./dataset/commoncatalog-cc-by-ext", output_filename + "_curation" + ".json"
        )
