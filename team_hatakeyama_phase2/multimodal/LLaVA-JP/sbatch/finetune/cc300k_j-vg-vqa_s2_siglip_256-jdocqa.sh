...
bash scripts/finetune/finetune_accelerate.sh \
    ./configs/train/finetune/batch_64-epoch_3.json \
    ...
    ./output_llava/checkpoints/finetune-llava-jp-Tanuki-8B-vision-cc300k_j-vg-vqa-s2_siglip_256-jdocqa \
    llava-jp-stage2 \
    Tanuki-8B-vision-cc300k_j-vg-vqa-s2_siglip_256-jdocqa \
