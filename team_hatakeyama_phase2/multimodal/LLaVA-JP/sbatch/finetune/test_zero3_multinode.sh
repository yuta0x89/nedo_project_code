...
bash scripts/finetune/finetune_accelerate_zero3_multinode.sh \
    ...
    ./output_llava/checkpoints/finetune-llava-jp-Tanuki-8B-vision-zero3-multinode-test \
    llava-jp-test \
    Tanuki-8B-vision-zero3-multinode-test \
    ./output_llava/checkpoints/pretrain-llava-jp-Tanuki-8B-vision-zero3-multinode-test/mm_projector.bin
