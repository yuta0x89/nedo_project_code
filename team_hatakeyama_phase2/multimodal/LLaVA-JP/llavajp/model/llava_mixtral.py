...
from transformers import AutoConfig, AutoModelForCausalLM, MixtralForCausalLM, \
                         MixtralModel, MixtralConfig
...
class LlavaMixtralForCausalLM(MixtralForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        super(LlavaMixtralForCausalLM, self).__init__(config)
