...
json_file_path = os.path.join('./out', 'aya_ja_evol_chosen-calm3-22b.jsonl')
skip_file_path = os.path.join('./out', 'aya_ja_evol_chosen-calm3-22b.txt')
...
def build_prompt(record):
    messages = [
        ...
        {"role": "user", "content": f'''{record['prompt'][-1]['content']}'''}
    ]
