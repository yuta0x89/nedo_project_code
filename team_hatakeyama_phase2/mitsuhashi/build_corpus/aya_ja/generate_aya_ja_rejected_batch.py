...
json_file_path = os.path.join('./out', 'aya_ja-calm3-22b.jsonl')
skip_file_path = os.path.join('./out', 'aya_ja-calm3-22b.txt')
...
dataset = load_dataset("ryota39/aya_ja_nemotron")['train']
...
def build_prompt(record):
    messages = [
        ...
        {"role": "user", "content": f'''{record['inputs']}'''}
    ]
