...
# cc from hf cleaned
python parquet_to_jsonl_ca.py --input_path /storage5/shared/p2_corpus/temporary_data/smollm-corpus/cosmopedia-v2 --out_dir /storage5/shared/p2_corpus/temporary_data/smollm-corpus/cosmopedia-v2/integ --column_name text --do_clean false