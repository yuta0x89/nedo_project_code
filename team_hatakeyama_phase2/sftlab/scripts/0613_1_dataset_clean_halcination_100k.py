...
概要
- ハルシネーションしそうなデータを抜いたinstruction
- codeや数学類は､最小限
...
#data_folder="data/0613clean_halcination_little_codes_100k"
data_folder="/storage5/personal/shioya/data/0613clean_halcination_little_codes_100k"
...
n_samples=write_jsonl(integ_records,f"{data_folder}/inst_data.parquet")
