...
def main() -> None:
    ...
    train_dataset = load_datasets(data_args.data_list, sft_training_args.hf_cache_dir, tokenizer, 'train')
    if training_args.do_eval:
        print("do eval")
        #eval_dataset = load_datasets(sft_training_args.eval_data_files)
        eval_dataset = load_datasets(data_args.data_list, sft_training_args.hf_cache_dir, tokenizer, 'eval')
