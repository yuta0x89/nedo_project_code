...
def load_datasets(data_files):
    ...
    for data_file in data_files:
        ...
        dataset = load_dataset("parquet", data_files=data_file,cache_dir="/storage5/personal/shioya/cache") #TODO: cache_dirのハードコードを適切なやり方に修正 
...
def main() -> None:
    ...
    wandb.init(entity=sft_training_args.wandb_entity, project=sft_training_args.wandb_project, name=training_args.output_dir)
