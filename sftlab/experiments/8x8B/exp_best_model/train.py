...
class SFTTrainingArguments:
    ...
    def __post_init__(self):
        ...
        if self.peft_target_model == "tanuki-8x8":
           self.peft_target_modules = [
                "q_proj",
                "k_proj",
                "v_proj",
...
#    training_args.resume_from_checkpoint=True
    if training_args.resume_from_checkpoint:
        ...
        trainer.train(resume_from_checkpoint='/storage5/someya/outputs/sftlab-experiments/8x8B/someya-sft_005-zero3/checkpoint-80')
    else:
